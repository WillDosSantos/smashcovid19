    ...
    <div className="content">
      <div>
        ...
        <article>
          ...
          <p>Blue Mug is a great way to start your morning. Wake up, and swing by the shop for your to-go order, and treat yourself to a relaxing break, rather than reveling in things that are outside of your control.</p>
          ...
          <p>Blue Mug has a wide variety of to-go drinks which you can <a href="http://www.blue-mug.com/menu/">view here</a>.</p>
         ...
         <h2 className="mt-1">The People</h2>
          ...
          <p>Blue Mug Coffe and Tea is owned by Stephanie Shumate. Along with her small crew, Stephanie serves the people of Escondido with great tasting drinks and a friendly atmosphere.</p>
          <p>The people of Blue Mug also support local community charities including and especially local law enforcement.</p>
          <p>To find out more about Blue Mug, check out their social media on <a href="https://www.facebook.com/BlueMugCoffeeTea/">Facebook</a>, <a href="https://www.instagram.com/bluemugcoffeeandtea/">Instagram</a>, and <a href="https://www.yelp.com/biz/blue-mug-coffee-and-tea-escondido-2">Yelp</a></p>
          </article>
        <article>
          <h2 style={{
            marginTop: `7em`,
