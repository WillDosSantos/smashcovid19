  ...
  <Layout>
            ...
            <div class="card">
              ...
              <div className="card-info">
                ...
                <ul className="d-f btn-group mt-1">
                  ...
                  <li>
                    <a className="btn btn--small" href="mailto:vaticanwilliam@gmail.com">Contact</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="card">
              ...
              <div className="card-info">
                ...
                <ul className="d-f btn-group mt-1">
                  ...
                  <li>
                    <a className="btn btn--small" href="mailto:ashdossantos07@gmail.com">Contact</a>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <section data-sal="slide-up" data-sal-easing="ease" data-sal-duration="1500" style={{ marginTop: `8em` }}>
      <div className="container p-r">
        <div style={{
          ...
          <a className="btn" href="mailto:smashcovid@gmail.com">Join the effort</a>
        </div>
    ...
    <section className="section--color">
      <div className="container">
        ...
        <p>We work with people of all faiths and beliefs that promote a positive outlook and encourage the betterment of mankind without causing harm. We are commiting to using our skill sets to help the community during times of striff or hardship.</p>
        <br/>
        <br/>
        <br/>
        </div>
